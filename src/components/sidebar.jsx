        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">Mike Bryant</a></h1>
              <span className="email"><i className="icon-mail"></i> mike.bryant.jr@icloud.com</span>
            </div>
            ...
            <div className="colorlib-footer">
              <p><small>
                Made by Me with <i className="icon-heart" aria-hidden="true" />
              </small></p>
            </div>
          </aside>
        </div>
